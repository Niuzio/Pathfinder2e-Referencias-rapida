data_reaction = [
  ...
  },
  {
    ...
    "subtitle": "No entrenado (acerca de teorías arcanas; tradiciones mágicas; criaturas de significado arcano (como constructos, bestias y elementales); y los Planos Ele mental, Astral y el Inframundo.)",
  ...
  },
  {
    ...
    "icon": "palm",
    "subtitle": "Entrenado",
    "description": "<p>&nbsp;Si eres un lanzador de conjuros arcanos que los prepara, puedes intentar preparar uno a partir del libro de conjuros de otro, del familiar de un brujo arcano o algo similar. El DJ es quien fija la CD basándose en el rango y en la rareza del conjuro; típicamente es un poco más fácil que Aprender el conjuro (pág. 228). </p><p><br></p><ul><li><strong>Éxito </strong>Preparas el conjuro prestado como parte de tus preparativos diarios normales. </li><li><strong>Fallo </strong>No consigues preparar el conjuro, pero el espacio de conjuro sigue disponible para que prepares uno diferente. No podrás in tentar preparar este conjuro de nuevo hasta la siguiente vez que prepares conjuros.</li><li><strong>Fallo crítico</strong> Infliges 2d6 daño al objeto. Aplica la Dureza del mismo a este daño</li></ul>",
    "reference": "Manual de jugador p.234",
    "bullets": [],
    "tags": [
      {
        "name": "concentrar",
  ...
  {
    "title": "Reparar",
    "icon": "hammer-and-nails",
    "subtitle": "No entrenado",
    "description": "<p><strong>Requisitos </strong>Empuñas o sostienes un equipo de reparaciones (pág. 288). </p><p><br></p><p>Inviertes 10 minutos tratando de arreglar un objeto dañado, colocándolo en una superficie estable y utilizando con ambas manos el equipo de reparaciones. Haz una prueba de Artesanía. El DJ es quien fija la CD, pero la de Reparar un objeto determinado suele ser la misma que la de Fabricarlo. No puedes Reparar un objeto destruido. </p><p><br></p><ul><li><strong>Éxito crítico</strong> Restableces al objeto 10 Puntos de Golpe, y otros 10 PG por rango de competencia en Artesanía (un total de 20 si tu rango es entrenado, 30 si es experto, 40 si es maestro o 50 si es legendario). </li><li><strong>Éxito </strong>Restableces al objeto 5 Puntos de Golpe, y otros 5 PG por rango de competencia en Artesanía (un total de 10 si tu rango es entre nado, 15 si es experto, 20 si es un maestro o 25 si es legendario).</li><li><strong>Fallo crítico</strong> Infliges 2d6 daño al objeto. Aplica la Dureza del mismo a este daño</li></ul>",
    "reference": "Manual de jugador p.234",
    "bullets": [],
    "tags": [
      {
  ...
  },
  {
    ...
    "icon": "hammer-and-nails",
    "subtitle": "Entrenado",
    "description": "<p>Puedes elaborar un objeto a partir de materias primas. Necesitas la dote de habilidad Artesanía alquímica para elaborar sustancias alquímicas y la dote de habilidad Artesanía mágica para fabricar objetos mágicos.</p><p><br></p><p>Para Elaborar un objeto debes cumplir los siguientes requisitos. </p><p><br></p><ul><li>El objeto es de tu nivel o inferior. Un objeto en el que no se indica nivel es de nivel 0. Si el objeto es de 9.º nivel o superior, tienes que disponer del rango maestro en Artesanía, y si es de nivel 17.º o superior, tienes que disponer del rango legendario. </li><li>El objeto tiene que ser común, o de lo contrario has de tener acceso al mismo. </li><li>Dispones de las herramientas apropiadas y, en muchos casos, de un taller. Por ejemplo, necesitas acceso a una herrería para forjar un escudo de metal, o a un laboratorio de alquimista para elaborar sustancias alquímicas. • Tienes que proveer materia prima por valor de por lo menos la mitad del precio del objeto. Siempre gastas por lo menos dicha cantidad de materia prima cuando Elaboras algo con éxito. Si estás en un asentamiento, por lo general puedes gastar dinero para obtener la cantidad necesaria de materia prima, excepto en el caso de materiales preciosos y raros. </li></ul><p><br></p><p>Después de invertir 2 días de trabajo en preparar las cosas (o 1 día si tienes la fórmula del objeto), haces una prueba de Artesanía. El DJ es quien determina la CD para Elaborar el objeto basándose en su nivel, en su rareza y en otras circunstancias.</p><p><br></p><p>Si tu intento de crear el objeto tiene éxito, gastas la materia prima aportada. Puedes pagar la parte restante del Precio del objeto en ma teriales para completarlo de inmediato, o puedes invertir días adicio nales de tiempo libre trabajando en él. Por cada día adicional invertido, reduce el valor de los materiales que necesitas gastar para completar el objeto. Dicha cantidad se determina utilizando la tabla de Ingresos obtenidos (pág. 230), basada en tu rango de competencia en Artesanía utilizando tu propio nivel en lugar de un nivel de tarea. </p><p><br></p><p>Después de transcurridos esos días de tiempo libre, puedes completar el objeto gastando la parte que queda de su Precio en mate riales. Si los días de tiempo libre que inviertes se ven interrumpidos, puedes volver más tarde acabar el objeto, continuando donde lo dejaste. En la barra lateral se puede ver un ejemplo de Artesanía. </p><p><br></p><ul><li><strong>Éxito crítico</strong> Tu intento tiene éxito. Cada día adicional invertido en practicar la Artesanía reduce los materiales necesarios para completar el objeto en una cantidad que se basa en tu nivel + 1 y en tu rango de competencia en la habilidad. </li><li><strong>Éxito </strong>Tu intento tiene éxito. Cada día adicional invertido en practicar la Artesanía reduce los materiales necesarios para completar el objeto en una cantidad que se basa en tu nivel y en tu rango de competencia en la habilidad</li><li><strong>Fallo </strong>No consigues completar el objeto. Puedes recuperar la materia prima que suministraste a su valor completo. Si quieres probar de nuevo, tienes que volver a empezar. </li><li><strong>Fallo crítico</strong> No consigues completar el objeto. Echas a perder el 10% de la materia prima suministrada, pero puedes recuperar el resto. Si quieres probar de nuevo, tienes que volver a empezar.</li></ul><p><br></p><p>&nbsp;<strong>Material alquímico y objetos mágicos</strong> </p><p><br></p><p>Si quieres Elaborar objetos mágicos o material alquímico, tienes que utilizar la dote de habilidad Artesanía alquímica (pág. 252) o Artesanía mágica (pág. 252) además de estar entrenado. Los bloques de estadísticas y los detalles de estos objetos apa recen en el Manual de dirección, así que consulta con tu DJ.</p><p><br></p><p><br></p><p><strong>Ejemplo de artesanía</strong></p><p><br></p><p>Ezren es un mago de 5.º nivel, y tiene el rango experto en Artesanía. Tiene un modificador a la Artesanía de +13 y la dote Artesanía mágica. Con 2 semanas de tiempo libre por delante, decide crear una runa de golpe, un objeto de 4.º nivel. El DJ determina en secreto una CD de 19.</p><p> El objeto tiene un Precio de 65 po, por lo que Ezren prepara 32 po y 5 pp en materia prima. Tiene también a mano otras 32 po y 5 pp en materia prima. Tras pasar 1 día preparando y lanzando conjuros, saca un 12 en su prueba de Artesanía, para un resultado de 25. ¡Eso es un éxito! En este punto, Ezren puede gastar las 32 po y 5 pp en materia prima restantes para completar el objeto de inmediato para un total de 65 po. </p><p>Sin embargo, a Ezren aún le quedan 13 días, por lo que decide invertir tiempo adicional en completar el objeto. Como quiera que es un personaje de 5.º nivel y tiene el rango experto en Artesanía, reduce la cantidad que tiene que pagar en 1 po por cada día invertido. Después de pasarse 13 días trabajando, reduce el coste total para completar el objeto de 65 po a 52 po. Invierte la parte que queda de su Precio en materiales, completa la runa de golpe y se dirige a su siguiente aventura (se podría haber quedado en casa y seguir trabajan do en la runa de golpe, para acabar reduciendo el Precio total del objeto a tan sólo la mitad de lo que había pagado, ¡pero las aventuras son mucho más lucrativas!). </p><p>Si el resultado de la prueba de Artesanía hubiera sido 29 o mayor, habría obtenido un éxito crítico. En dicho caso, hu biera reducido la cantidad restante en unas 2 po por día (la cantidad para un experto de 6.º nivel), reduciendo la cantidad necesaria para completar el objeto tras 13 días adicionales de trabajo a 39 po.</p><p><br></p><p><br></p><p><strong>Consumibles y munición  </strong></p><p><br></p><p>Puedes Elaborar objetos con el rasgo consumible en lotes, preparando hasta cuatro lotes del mismo objeto a la vez con una sola prueba. Esto requiere que incluyas la materia prima para todos los objetos del lote al inicio, y tienes que completar todo el lote a la vez. También puedes elaborar munición no mágica en lotes, utilizando la cantidad indicada en la tabla Armas a distancia (típicamente 10, pág. 281).</p><p><br></p><p><br></p><p><strong>Formulas</strong></p><p><br></p><p>Una fórmula escrita para un objeto te ayuda a crearlo con menos dificultad. Esto tiene dos funciones. En primer lugar, reduce el tiempo necesario para empezar a Elaborar de 2 días a 1, porque tienes menos preparación que hacer. En segundo lugar, puedes Elaborar objetos poco comunes y aún más raros si eres capaz de obtener sus fórmulas. Consulta las reglas de la pág. 294 para más información sobre las fórmulas.</p>",
    "reference": "Manual de jugador p.234",
    "bullets": [],
    "tags": [
      {
  ...
  },
  {
    ...
    "icon": "magnifying-glass",
    "subtitle": "Entrenado",
    "description": "<p>&nbsp;<strong>Requisitos </strong>Empuñas o sostienes un juego de herramientas de alquimista (pág. 288).</p><p><br></p><p>Puedes identificar la naturaleza de una sustancia alquímica tras 10 minutos de ensayo utilizando tu juego de herramientas de alqui mista. Si tu intento es interrumpido de alguna forma, tienes que empezar de nuevo. </p><p><br></p><ul><li><strong>Éxito </strong>Identificas el material y la forma de activarlo. </li><li><strong>Fallo </strong>No consigues identificar el material pero puedes probar de nuevo. </li><li><strong>Fallo crítico</strong> Identificas erróneamente el material como otro, a elección del DJ.</li></ul>",
    "reference": "Manual de jugador p.234",
    "bullets": [],
    "tags": [
      {
  ...
  },
  {
    "title": "Recordar conocimiento [one-action]",
    "icon": "magnifying-glass",
    "subtitle": "No entrenado (acerca de antiguos misterios; filosofías oscuras, criaturas de significación ocultista (como por ejemplo las aberraciones, los espíritus y los cienos); y los Planos esotéricos como el Plano Astral, la Forja de la Creación, el Plano Etéreo, el Inframundo y el Vacío.",
    "description": "<p>&nbsp;Haces una prueba de habilidad para intentar recordar un fragmento de conocimiento sobre un tema relacionado con dicha habilidad. Sugiere qué habilidad querrías usar y formula una pregunta al DJ. El DJ es quien determina la CD. Podrías tener que colaborar con él para acotar la pregunta o las habilidades, y podrías decidir no Recordar conocimiento antes de decidirte por la acción si no te gustan tus opciones.</p><p><br></p><ul><li><strong>Éxito crítico</strong> Recuerdas con exactitud el conocimiento. El DJ responde a tu pregunta con veracidad y, o bien te proporciona información o contexto adicionales, o bien contesta una pregunta de seguimiento</li><li><strong>Éxito </strong>Recuerdas con exactitud el conocimiento. El DJ responde a tu pregunta con veracidad.</li><li><strong>Fallo </strong>No obtienes información alguna.</li><li><strong>Fallo crítico</strong> Recuerdas información incorrecta. El DJ responde a tu pregunta con una falsedad (o decide no proporcionarte información alguna, como en un fallo).</li></ul><p><br></p><p><strong>Tareas de Recordar conocimiento</strong></p><p><br></p><p>Los siguientes ejemplos utilizan Sociedad o Religión.</p><p><br></p><ul><li><strong>No entrenado</strong> el nombre de un gobernante, jefe de estado, noble clave o dios principal</li><li><strong>Entrenado </strong>la línea sucesoria de una familia noble principal, las doctrinas centrales de un dios principal Experto la genealogía de un noble menor, las enseñanzas de un antiguo sacerdote</li><li><strong>Maestro </strong>la jerarquía de la corte de un genio noble, los templos extraplanarios principales de un dios</li><li><strong>Legendario </strong>la existencia de un heredero noble largo tiempo perdido, las doctrinas secretas de una religión</li></ul><p><br></p>",
    "reference": "Manual de jugador p.231",
    "bullets": [],
    "tags": [
  ...
  },
  {
    "title": "Recordar conocimiento [one-action]",
    "icon": "magnifying-glass",
    "subtitle": "No entrenado (acerca de los agentes  divinos, los puntos más sutiles de la teología, los mitos  oscuros relativos a una fe y las criaturas de significa do religioso (como los celestiales, los infernales y los muertos vivientes), la Forja de la Creación, el Vacío y la Esfera Exterior.)",
    "description": "<p>&nbsp;Haces una prueba de habilidad para intentar recordar un fragmento de conocimiento sobre un tema relacionado con dicha habilidad. Sugiere qué habilidad querrías usar y formula una pregunta al DJ. El DJ es quien determina la CD. Podrías tener que colaborar con él para acotar la pregunta o las habilidades, y podrías decidir no Recordar conocimiento antes de decidirte por la acción si no te gustan tus opciones.</p><p><br></p><ul><li><strong>Éxito crítico</strong> Recuerdas con exactitud el conocimiento. El DJ responde a tu pregunta con veracidad y, o bien te proporciona información o contexto adicionales, o bien contesta una pregunta de seguimiento</li><li><strong>Éxito </strong>Recuerdas con exactitud el conocimiento. El DJ responde a tu pregunta con veracidad.</li><li><strong>Fallo </strong>No obtienes información alguna.</li><li><strong>Fallo crítico</strong> Recuerdas información incorrecta. El DJ responde a tu pregunta con una falsedad (o decide no proporcionarte información alguna, como en un fallo).</li></ul><p><br></p><p><strong>Tareas de Recordar conocimiento</strong></p><p><br></p><p>Los siguientes ejemplos utilizan Sociedad o Religión.</p><p><br></p><ul><li><strong>No entrenado</strong> el nombre de un gobernante, jefe de estado, noble clave o dios principal</li><li><strong>Entrenado </strong>la línea sucesoria de una familia noble principal, las doctrinas centrales de un dios principal Experto la genealogía de un noble menor, las enseñanzas de un antiguo sacerdote</li><li><strong>Maestro </strong>la jerarquía de la corte de un genio noble, los templos extraplanarios principales de un dios</li><li><strong>Legendario </strong>la existencia de un heredero noble largo tiempo perdido, las doctrinas secretas de una religión</li></ul><p><br></p>",
    "reference": "Manual de jugador p.231",
    "bullets": [],
    "tags": [
  ...
  },
  {
    "title": "Recordar conocimiento [one-action]",
    "icon": "magnifying-glass",
    "subtitle": "No entrenado (acerca de la historia  local, las personalidades importantes, las instituciones le gales, la estructura societaria y las culturas humanoides. El  DJ podría permitir que Sociedad se aplicara a otras criaturas que resultan ser elementos principales de la sociedad de tu región, como por ejemplo la nobleza dracónica en un reino de humanos gobernado por dragones.)",
    "description": "<p>&nbsp;Haces una prueba de habilidad para intentar recordar un fragmento de conocimiento sobre un tema relacionado con dicha habilidad. Sugiere qué habilidad querrías usar y formula una pregunta al DJ. El DJ es quien determina la CD. Podrías tener que colaborar con él para acotar la pregunta o las habilidades, y podrías decidir no Recordar conocimiento antes de decidirte por la acción si no te gustan tus opciones.</p><p><br></p><ul><li><strong>Éxito crítico</strong> Recuerdas con exactitud el conocimiento. El DJ responde a tu pregunta con veracidad y, o bien te proporciona información o contexto adicionales, o bien contesta una pregunta de seguimiento</li><li><strong>Éxito </strong>Recuerdas con exactitud el conocimiento. El DJ responde a tu pregunta con veracidad.</li><li><strong>Fallo </strong>No obtienes información alguna.</li><li><strong>Fallo crítico</strong> Recuerdas información incorrecta. El DJ responde a tu pregunta con una falsedad (o decide no proporcionarte información alguna, como en un fallo).</li></ul><p><br></p><p><strong>Tareas de Recordar conocimiento</strong></p><p><br></p><p>Los siguientes ejemplos utilizan Sociedad o Religión.</p><p><br></p><ul><li><strong>No entrenado</strong> el nombre de un gobernante, jefe de estado, noble clave o dios principal</li><li><strong>Entrenado </strong>la línea sucesoria de una familia noble principal, las doctrinas centrales de un dios principal Experto la genealogía de un noble menor, las enseñanzas de un antiguo sacerdote</li><li><strong>Maestro </strong>la jerarquía de la corte de un genio noble, los templos extraplanarios principales de un dios</li><li><strong>Legendario </strong>la existencia de un heredero noble largo tiempo perdido, las doctrinas secretas de una religión</li></ul><p><br></p>",
    "reference": "Manual de jugador p.231",
    "bullets": [],
    "tags": [
  ...
  },
  {
    "title": "Subsistir",
    "icon": "campfire",
    "subtitle": "No entrenado (en las tierras vírgenes forrajeando en  busca de comida y construyendo refugios.)",
